    ...
    let contacts: Contact[] = [
      {
        ...
        //dateOfBirth: new Date('1994/05/05').toISOString(), // when it's a string type
      ...
      },
      {
        ...
        favoritesRanking: 1,
        phones: [{ phoneNumber: '555-123-4567', phoneType: 'mobile' }, { phoneNumber: '555-321-7890', phoneType: 'work' }],
        address: {
